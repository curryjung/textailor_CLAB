...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--dataset_dir', default=None, type=str, help='Path to dataset directory')
		self.parser.add_argument('--user_ckpt_path', default=None, type=str, help='Path to checkpoint to resume training from')
