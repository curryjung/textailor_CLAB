...
from models.stylegan2.op_textailor import FusedLeakyReLU, fused_leaky_relu, upfirdn2d, conv2d_gradfix
...
class Discriminator(nn.Module):
    def __init__(self, channel_multiplier=2, blur_kernel=[1, 3, 3, 1]):
        ...
        self.final_linear = nn.Sequential(
            EqualLinear(channels[4] * 4 * 16, channels[4], activation="fused_lrelu"),
...
class only_Generator(nn.Module):
    def __init__(
        self,
        size,
        style_dim,
...
class only_Discriminator(nn.Module):
