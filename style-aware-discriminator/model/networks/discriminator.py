...
class StyleDiscriminator(nn.Module):
    def __init__(
        ...
        self.intermediate_feat_num = intermediate_feat_num
    ...
    def get_intermediate_features(self, input):
        for i, tmp_encoder in enumerate(self.encoder):
            input = tmp_encoder(input)
            if i == self.intermediate_feat_num:
                break
